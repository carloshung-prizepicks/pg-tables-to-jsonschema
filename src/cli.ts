...
(async () => {
  ...
  program
    ...
    .option( '-o, --out [file]',              'Output folder. Default output is to STDOUT only JSON schema. JSON API and rswag schemas are written to file only. A sub-folder will be created per schema' )
